...
public class Board : MonoBehaviour
{
    ...
    public void CreateNewBoard()
    {
        ...
        for (int i = 0; i < Random.Range(GameConstants.MinBins,GameConstants.MaxBins + 1); i++)
        {
            GameObject binObject = Instantiate<GameObject>(prefabBin, transform.position, Quaternion.identity);
