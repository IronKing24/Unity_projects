...
public class Bin : MonoBehaviour
{
	...
	void Awake()
    {
        ...
        lowerLeftCorner = new Vector3(transform.position.x - binWidth / 2 + spaceSize, transform.position.y - binHeight / 2, 0);
	}
    ...
    void AddTeddyBear()
    {
        ...
        Vector3 offset = new Vector3(
            ...
            teddyBearHeight / 2 + row * teddyBearHeight, 0);

        // add new teddy bear to list
        teddyBears.Add(Instantiate(prefabTeddyBear, lowerLeftCorner + offset, Quaternion.identity));
    }
