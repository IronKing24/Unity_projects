...
public static class EventManager
{
    ...
    static List<UnityAction<PlayerName, Difficulty, Difficulty>> gameOverListeners = new List<UnityAction<PlayerName, Difficulty, Difficulty>>();

    static List<Hud> RestartgameInvokers = new List<Hud>();
    static List<UnityAction> RestartgameListeners = new List<UnityAction>();
    ...
    public static void AddRestartGameInvoker(Hud invoker)
    {
        RestartgameInvokers.Add(invoker);
        foreach (UnityAction listener in RestartgameListeners)
        {
            invoker.AddrestartgameListeners(listener);
        }
    }

    public static void AddRestartGameListener(UnityAction listener)
    {
        RestartgameListeners.Add(listener);
        foreach (Hud invoker in RestartgameInvokers)
        {
            invoker.AddrestartgameListeners(listener);
        }
    }
